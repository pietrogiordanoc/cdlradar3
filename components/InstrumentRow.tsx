        ...
        <div className="flex flex-row items-center justify-between w-full">
          ...
          <div className="w-1/4 flex flex-col">
            <div className="flex items-center space-x-3">
              {/* ICONOS (Mantenidos exactamente como estaban) */}
          ...
          {/* COLUMNAS MTF, SCORE, SESSION, ACCIÓN (Mantenidas exactamente igual) */}
          ...
          <div className="w-40 text-center text-[10px] font-bold text-neutral-500 uppercase">{isMarketOpen(instrument.type, instrument.symbol) ? <span className="text-emerald-500/60">Abierto</span> : 'Cerrado'}</div>
          ...
          {/* TRADE TRACKER (DISEÑO BADGE MANTENIDO) */}
